...
def write_svg(tm, fname, include_arcs = False):
  with open(fname, 'w') as f:
    ...
    f.write('<svg width="76mm" height="76mm" viewBox="0 0 76 76" xmlns="http://www.w3.org/2000/svg" version="1.1">\n')
    f.write('<g transform="translate(38,38) scale(1,-1)">\n')
    if include_arcs:
...
init_scale = 2 * phi * phi * phi * phi * phi * phi
tm = TileManager()
